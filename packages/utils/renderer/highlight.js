...
var hljs = (function () {
	...
	const y = {
		...
		render(e) {
			return e('pre', {}, [
				e('code', { class: this.className, domProps: { innerHTML: this.highlighted } }),
			]);
		},
	},
		R = {
	...
	return (function (t) {
		...
		function b(e, t, a, s) {
			...
			function x(t, r) {
				...
				if (((m = r), 'begin' === r.type))
					return (function (e) {
						...
						return (
							...
							r.skip
								? (L += t)
								: (r.excludeBegin && (L += t), u(), r.returnBegin || r.excludeBegin || (L = t)),
							h(r),
				...
				if ('illegal' === r.type && !a) {
					const e = Error(
						'Illegal lexeme "' + i + '" for mode "' + (R.className || '<unnamed>') + '"',
					);
					throw ((e.mode = R), e);
				}
				if ('end' === r.type) {
			...
			try {
				...
				return (
					...
					M.finalize(),
					(w = M.toHTML()),
					{ relevance: j, value: w, language: e, illegal: !1, emitter: M, top: R }
				);
			} catch (n) {
		...
		return function (e) {
			...
			var n = '(decltype\\(auto\\)|' + t('[a-zA-Z_]\\w*::') + '[a-zA-Z_]\\w*' + t('<.*?>') + ')',
				...
				_ = {
					...
					keywords: l,
					contains: d.concat([
						{ begin: /\(/, end: /\)/, keywords: l, contains: d.concat(['self']), relevance: 0 },
					]),
					relevance: 0,
				},
				u = {
		...
		return function (e) {
			...
			return {
				...
				contains: [
					...
					e.COMMENT('///+\\s*', '$', {
						contains: [{ subLanguage: 'markdown', begin: '.', end: '$', relevance: 0 }],
					}),
					e.C_LINE_COMMENT_MODE,
					e.C_BLOCK_COMMENT_MODE,
					{
			...
			return {
				...
				contains: o.concat([
					...
					},
					{
						...
						illegal: /[:="\[\]]/,
						contains: [
							{ beginKeywords: 'extends', endsWithParent: !0, illegal: /[:="\[\]]/, contains: [c] },
							c,
						],
					},
		...
		return (e) => {
			...
			return {
				...
				contains: [
					...
					x('abi', 'decode encode encodePacked encodeWithSelector encodeWithSignature'),
					x('bytes', 'concat'),
					f,
					{
						className: 'class',
		...
		return function (e) {
			var t = "[a-zA-Z_\\-!.?+*=<>&#'][a-zA-Z_\\-!.?+*=<>&#'0-9/;:]*",
				...
				g = {
					...
					contains: [
						{ className: 'title', begin: t, relevance: 0, excludeEnd: !0, endsParent: !0 },
					].concat(y),
				};
			return (
				...
				(d.contains = y),
				(m.contains = [d]),
				{ name: 'Clojure', aliases: ['clj'], illegal: /\S/, contains: [p, o, l, m, i, u, d, s, c] }
			);
		};
	})(),
);
		...
		return function (e) {
			return {
				...
				contains: [
					...
					hljs.NUMBER_MODE,
					{ className: 'punctuation', begin: /[.]{3}/, end: '\\W', relavance: 0 },
					{ className: 'variable', begin: /\$/, end: '\\W', excludeEnd: !0 },
					{ className: 'meta', begin: /@\w+/, end: '\\W', excludeEnd: !0 },
					{ className: 'symbol', begin: /[_A-Za-z][_0-9A-Za-z]*(?=:)/, end: '\\W', relavance: 0 },
				],
				illegal: /[;<']|BEGIN/,
			};
		};
		...
		return function (e) {
			return {
				...
				contains: [
					...
					hljs.QUOTE_STRING_MODE,
					hljs.NUMBER_MODE,
					{ className: 'punctuation', begin: /[,;.\[\]{}()]/, end: '\\W', relavance: 0 },
					{ className: 'variable', begin: /\b\w+\b(?=\s*\.)/, end: '\\W', excludeEnd: !0 },
				],
				illegal: /[<']/,
			};
		};
	...
	(function () {
		...
		return function (e) {
			var n = '[a-zA-Z_\\-\\+\\*\\/\\<\\=\\>\\&\\#][a-zA-Z0-9_\\-\\+\\*\\/\\<\\=\\>\\&\\#!]*',
				...
				c = {
					contains: [s, b, l, t, { begin: '\\(', end: '\\)', contains: ['self', a, b, s, r] }, r],
					variants: [
						{ begin: "['`]\\(", end: '\\)' },
				...
				d = { variants: [{ begin: "'" + n }, { begin: "#'" + n + '(::' + n + ')*' }] },
				o = { begin: '\\(\\s*', end: '\\)' },
				u = { endsWithParent: !0, relevance: 0 };
			return (
				(o.contains = [
					{ className: 'name', variants: [{ begin: n }, { begin: '\\|[^]*?\\|' }] },
					u,
				]),
				(u.contains = [c, d, o, a, s, b, g, l, t, { begin: '\\|[^]*?\\|' }, r]),
				{ name: 'Lisp', illegal: /\S/, contains: [s, e.SHEBANG(), a, b, g, c, d, o, r] }
			);
		};
	})(),
);
